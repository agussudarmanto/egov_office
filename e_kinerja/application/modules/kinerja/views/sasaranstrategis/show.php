...
<div class="panel panel-default">
  ...
  <table id="detail" class="table table-striped table-condensed">
    ...
    <tr>
      <td width="20%" align="right"><strong>Sasaran Strategis Es.I</strong></td>
  ...
  <div class="panel-footer">
    <div class="row">
      <div class="col-md-10 col-sm-12 col-md-offset-2 col-sm-offset-0"><a href="<?php echo site_url('kinerja/sasaranstrategis'); ?>" class="btn btn-default"><i class="glyphicon glyphicon-chevron-left"></i> Kembali</a></div>
    </div>
  </div>
  <!-- / Panel Footer-->
</div>
