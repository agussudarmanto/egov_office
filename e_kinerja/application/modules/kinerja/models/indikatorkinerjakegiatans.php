...
class indikatorkinerjakegiatans extends CI_Model
{
    ...
    function count_all_search() {
        ...
        $this->db->or_like('indikatorkinerjakegiatan.sasaran_id', $keyword);
        $this->db->or_like('indikatorkinerjakegiatan.dukungan_id', $keyword);
        $this->db->or_like('indikatorkinerjakegiatan.kode', $keyword);
        $this->db->or_like('indikatorkinerjakegiatan.indikatorkinerjakegiatan', $keyword);
        $this->db->or_like('indikatorkinerjakegiatan.satuan', $keyword);
        $this->db->or_like('indikatorkinerjakegiatan.prioritas_id', $keyword);
        return $this->db->count_all_results();
    }
    ...
    function save() {
        ...
        $data = array(
                'sasaran_id' => strip_tags($this->input->post('sasaran_id', TRUE)),
                'dukungan_id' => strip_tags($this->input->post('dukungan_id', TRUE)),
                'kode' => strip_tags($this->input->post('kode', TRUE)),
                'indikatorkinerjakegiatan' => strip_tags($this->input->post('indikatorkinerjakegiatan', TRUE)),
